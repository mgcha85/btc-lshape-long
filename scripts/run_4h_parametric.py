...
def run_parametric_study():
    print("=" * 60)
    print("4시간봉 Parametric Study")
    print("=" * 60)
    
    ma_periods = [25, 50, 100]
    consolidation_bars_list = [3, 5, 7]
    consolidation_range_list = [3.0, 5.0, 7.0]
    drop_threshold_list = [5.0, 7.0, 10.0]
    take_profit_pcts = [7.0, 10.0, 15.0]
    stop_loss_pcts = [3.0, 5.0, 7.0]
    
    all_ma_periods = list(set(ma_periods + [25, 50, 100, 200, 400]))
    
    print("\n[1/3] Loading 4-hour data...")
    ...
    csv_path = OUTPUT_DIR / "4h_parametric_results.csv"
...
def run_half_close_study(best_config: dict):
    ...
    hc_csv_path = OUTPUT_DIR / "4h_half_close_results.csv"
